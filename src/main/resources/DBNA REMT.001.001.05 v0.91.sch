...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2" xmlns:sqf="http://www.schematron-quickfix.com/validator/process">
    ...
    <sch:pattern id="remt.001-027">
        <sch:rule context="qdt:Cd">
            <sch:assert test="ancestor::qdt:LclInstrm[ancestor::qdt:PmtTpInf[ancestor::qdt:OrgnlPmtInf[ancestor::qdt:RmtInf[ancestor::qdt:RmtAdvc]]]]] and . = ''">
                OrgnlPmtInf LclInstrm Cd is not supported.
            </sch:assert>
        </sch:rule>
    </sch:pattern>
    -->
