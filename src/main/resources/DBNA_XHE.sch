...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2"
    ...
    <!-- Validate the InstanceEncryptionMethod element if InstanceEncryptionIndicator is true -->
    <!-- <sch:pattern id="validate-instance-encryption-method">
        <sch:rule context="xhe:XHE/xha:Payloads/xha:Payload">
            <sch:assert test="xhb:InstanceEncryptionIndicator = 'true' and xhb:InstanceEncryptionMethod">
                The xhb:InstanceEncryptionIndicator must be true and xhb:InstanceEncryptionMethod must be present.
            </sch:assert>
        </sch:rule>
    </sch:pattern> -->
